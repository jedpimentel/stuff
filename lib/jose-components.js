...
AFRAME.registerComponent("joses-default-interface", {
  ...
  init: function() {
    ...
    // copied from stuff\demo\oculus-quest\index.html as-was, need to make that code reference this lib

    const has_positional = AFRAME.utils.device.checkHeadsetConnected();
...
AFRAME.registerComponent('debug-menu', {
  ...
  init: function() {
    ...
    this.log = function(val) {
      ...
      text.setAttribute('wrap-count', 1000);
