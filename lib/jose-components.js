...
AFRAME.registerComponent('pos-trail-line', {
  schema: {
    // targetID: {type: 'string', default: 'n/a'}
    segments: {type: 'number', default: 72}//Oculus Quest target framerate
  },
  init: function() {
  ...
  tick: function() {
    ...
    this.vertices[this.segment_index * 2    ].copy(this.last_pos);
    this.vertices[this.segment_index * 2 + 1].copy(this.position);
