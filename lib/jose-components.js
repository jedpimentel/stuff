  ...
  init: function() {
    ...
    const POSITIONAL_UI = `
      <a-entity id="camera-wrapper">
        ...
        <a-entity pos-trail-line laser-controls="hand: right" draw-on-intersection grip-to-move="targetID: camera-wrapper" raycaster="objects: .clickable; far:0.15">
    ...
    const MOUSE_AND_KEYBOARD_UI = `
      <a-entity id="camera-wrapper">
        <a-camera look-controls="pointerLockEnabled: true" near="0.001" wasd-controls>
            ...
            <a-entity position="0.2 -0.4 -1.4" cursor="rayOrigin: entity; showLine: true;" draw-on-intersection raycaster="objects: .clickable; showLine: true; far: 16" line="color: white; opacity:0.5"></a-entity>
        </a-camera>
        <a-box id="home-button" class="clickable" height="0.02" width="0.05" depth="0.05" position="0 -0.05 0" color="red"></a-box>
      </a-entity>
    `
